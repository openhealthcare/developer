...
## Development Environment (Vagrant Box)

The Open Health Care Development Environment aims to provide a standard development environment for all OHC projects.
